...
/***/ 7341:
/*!*******************************************************!*\
  !*** ./src/app/cadastro/services/cadastro.service.ts ***!
  \*******************************************************/
...
let CadastroService = (_class = class CadastroService {
  ...
  adicionar(cadastro) {
    return this.httpClient.post(`${this.API}/cadastro`, cadastro);
  }
  listar() {
    return this.httpClient.get(this.API);
  }
  buscarPorId() {
    return this.httpClient.get(`${this.API}/alterar-dados`);
  }
  atualizar(cadastro) {
    return this.httpClient.put(this.API, cadastro);
  }
...
CadastroService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], CadastroService);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_letic_carteira_facil_angular_spring_carteira_facil_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_letic_carteira_facil_angular_spring_carteira_facil_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_letic_carteira_facil_angular_spring_carteira_facil_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
